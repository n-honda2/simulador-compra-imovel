...
def test_simulacao_request_valid_data():
    ...
    """
    data = {"valor_imovel": 500000.0, "percentual_entrada": 15.0, "anos_contrato": 3}
...
def test_simulacao_request_invalid_percentual_entrada_low():
    ...
    """
    invalid_data = {"valor_imovel": 100000.0, "percentual_entrada": 4.0, "anos_contrato": 2}  # Inválido
...
def test_simulacao_request_invalid_percentual_entrada_high():
    ...
    """
    invalid_data = {"valor_imovel": 100000.0, "percentual_entrada": 21.0, "anos_contrato": 2}  # Inválido
...
def test_simulacao_request_invalid_anos_contrato_low():
    ...
    """
    invalid_data = {"valor_imovel": 100000.0, "percentual_entrada": 10.0, "anos_contrato": 0}  # Inválido
    with pytest.raises(ValidationError):
        SimulacaoRequest(**invalid_data)
...
def test_simulacao_request_invalid_anos_contrato_high():
    ...
    """
    invalid_data = {"valor_imovel": 100000.0, "percentual_entrada": 10.0, "anos_contrato": 6}  # Inválido
    with pytest.raises(ValidationError):
        SimulacaoRequest(**invalid_data)
...
def test_simulacao_request_invalid_valor_imovel():
    ...
    """
    invalid_data = {"valor_imovel": 0.0, "percentual_entrada": 10.0, "anos_contrato": 2}  # Inválido
    with pytest.raises(ValidationError):
        SimulacaoRequest(**invalid_data)
...
def test_simulacao_response_creation():
    ...
    response = SimulacaoResponse(
        valor_entrada=50000.0, valor_financiado=450000.0, total_a_guardar=75000.0, parcela_mensal=2083.33
    )
