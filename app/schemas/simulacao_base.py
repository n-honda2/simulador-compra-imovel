...
class SimulacaoResponse(BaseModel):
    ...
    total_a_guardar: float = Field(..., description="Valor totoal guardado no fim do contrato (? rever o modelo de negócios depois).")
    parcela_mensal: float = Field(..., description="Valor estimado da parcela mensal do financiamento no modelo de negócios da aMORA.")
